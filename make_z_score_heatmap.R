...
parp7ko_up=subset(parp7ko_noGm_riken,parp7ko_noGm_riken$padj < 0.01 & parp7ko_noGm_riken$log2FoldChange > 1)
parp7ko_dn=subset(parp7ko_noGm_riken,parp7ko_noGm_riken$padj < 0.01 & parp7ko_noGm_riken$log2FoldChange < -1)
